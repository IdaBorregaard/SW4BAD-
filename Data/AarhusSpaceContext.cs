    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Mission>()
            ...
            .UsingEntity<Dictionary<string, object>>(
                "AstronautMission",
                j => j.HasOne<Astronaut>().WithMany().HasForeignKey("StaffId"),
        ...
        modelBuilder.Entity<Mission>()
            ...
            .UsingEntity<Dictionary<string, object>>(
             "ScientistMission",
                j => j.HasOne<Scientist>().WithMany().HasForeignKey("StaffId"),
                j => j.HasOne<Mission>().WithMany().HasForeignKey("MissionId")
    )   ;
        ...
        modelBuilder.Entity("AstronautMission").HasData(
            new { StaffId = 201, MissionId = 1 }, // 1 = Mission X
            new { StaffId = 202, MissionId = 1 },
            new { StaffId = 203, MissionId = 1 },
            new { StaffId = 204, MissionId = 1 },
            new { StaffId = 205, MissionId = 1 },
            new { StaffId = 202, MissionId = 2 }, // 2 = Apollo 11
            new { StaffId = 203, MissionId = 2 }
        );

        // Assign the Scientists to the Missions
        modelBuilder.Entity("ScientistMission").HasData(
            new { StaffId = 101, MissionId = 1 },
            new { StaffId = 102, MissionId = 1 },
            new { StaffId = 101, MissionId = 2 },
            new { StaffId = 102, MissionId = 2 },
            new { StaffId = 103, MissionId = 2 }
        );
